...
import '../providers/location_list_notifier.dart';
...
class _LocationListScreenState extends ConsumerState<LocationListScreen> {
  ...
  void _onScroll() {
    ...
    if (pos.pixels >= pos.maxScrollExtent - 200) {
      ref.read(locationListProvider.notifier).loadNextPage();
    }
  }
  ...
  void _clearSearch() {
    ...
    ref.read(locationListProvider.notifier).search('');
  }

  @override
  Widget build(BuildContext context) {
    final asyncState = ref.watch(locationListProvider);

    return Scaffold(
      appBar: AppBar(title: const Text('Lugares'), centerTitle: true),
      body: Column(
        children: [
          _SearchBar(
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const Text('No se encontraron lugares'),
